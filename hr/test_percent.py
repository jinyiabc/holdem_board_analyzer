...
sns.heatmap(pivot_data91, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[0,0], cbar = False);

sns.heatmap(pivot_data92, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[0,1], cbar = False);

sns.heatmap(pivot_data93, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[0,2], cbar = False);

sns.heatmap(pivot_data61, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[1,0], cbar = False);

sns.heatmap(pivot_data62, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[1,1], cbar = False);

sns.heatmap(pivot_data63, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[1,2], cbar = False);

sns.heatmap(pivot_data31, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[2,0], cbar = False);

sns.heatmap(pivot_data32, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[2,1], cbar = False);

sns.heatmap(pivot_data33, annot=labels, fmt="", linewidths=.5, square = True, cmap = 'Blues_r', ax = axes[2,2], cbar = False);
