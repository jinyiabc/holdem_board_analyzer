...
rank_list=[rank1,rank2,rank3,rank4,rank1,rank1,rank1,rank1]
...
def list_group_card_turn4(handRanges,rank_list,dead_cards):
    list=[]
                ...
                for idx3, b3 in enumerate(rank_list[2]):
                    for idx4, b4 in enumerate(rank_list[3]):
                        ...
                        if idx1<idx2<idx3<idx4:  # 715
                            ...
                            '''
                        if idx1==idx2 and idx2<idx3<idx4:  #286
                            #pass
                            rb[(b1+b2+b3+b4)]=12
                        if idx1<idx2 and idx2==idx3<idx4:  # 286
                            #pass
                            rb[(b1+b2+b3+b4)]=12
                        if idx1<idx2<idx3 and idx3==idx4:  # 286
                            #pass
                            rb[(b1+b2+b3+b4)]=12
