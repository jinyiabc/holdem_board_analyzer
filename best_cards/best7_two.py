...
rank_list=[rank1,rank1,rank2,rank2,rank2,rank1,rank1,rank1,rank1,rank2]
...
def list_group_card_river2(handRanges,rank_list,dead_cards):
    list=[]
    for hr in handRanges:
        ...
        for idx1,b1 in enumerate(rank_list[5]):   # (4,1,0,0) = 12*9295  iteration=2002 => 1430
